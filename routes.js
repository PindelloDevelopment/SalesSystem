...
async function getAccountExecutivesPage(req,res){
    res.status(200).sendFile(path.join(__dirname + "/assets/html/Pages/Account_Executive.html"));
}
async function getBirthdaysPage(req,res){
    res.status(200).sendFile(path.join(__dirname + "/assets/html/Pages/Birthdays.html"));
}
async function getBlackbookPage(req,res){
    res.status(200).sendFile(path.join(__dirname + "/assets/html/Pages/Blackbook.html"));
}
async function getCompanyHouseSearchPage(req,res){
    res.status(200).sendFile(path.join(__dirname + "/assets/html/Pages/Company_House_Search.html"));
}
async function getTemplatePage(req,res){
    res.status(200).sendFile(path.join(__dirname + "/assets/html/Pages/PageTemplate.html"));
}
async function getSideBarPage(req,res){
    res.status(200).sendFile(path.join(__dirname + "/assets/html/Pages/Side_Bar.html"));
}
...
module.exports = {getIndexPage,
                getAccountExecutivesPage,
                getBirthdaysPage,
                getBlackbookPage,
                getCompanyHouseSearchPage,
                getTemplatePage,
                getSideBarPage,
